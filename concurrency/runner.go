...
var TimeoutError = errors.New("received timeout")
var InterruptedError = errors.New("received interrupted signal")
...
// ExampleRun is directly part of Runner API but just to demonstrate it works
func ExampleRun() {
